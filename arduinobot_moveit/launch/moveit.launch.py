...
#THIS WILL LAUNCH THE TRAJECTORY PLANNING PACKAGE
def generate_launch_description():
    is_sim_arg = DeclareLaunchArgument(
        "is_sim",
        default_value="True"
    )
#THIS LAUNCHES THE URDF FOR THE ROBOT AND THE CONTROLLER
...
#THIS LAUNCHES RVIZ VISUALIZATION
